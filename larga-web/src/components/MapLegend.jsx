    ...
    <aside aria-label="Map legend" className="absolute left-4 top-32 z-10 w-44 rounded-2xl bg-white/95 p-3 shadow-lg shadow-black/10 backdrop-blur-sm md:bottom-9 md:left-auto md:right-4 md:top-auto">
      ...
      <div id="map-legend-items" className={`${expanded ? 'block' : 'hidden'} md:block`}>
        <ul className="font-regular space-y-2 text-[11px] text-gray-600">
          ...
          <li className="flex items-center gap-2"><span className="flex h-6 w-6 items-center justify-center relative"><img src="/larga-jeep/larga-jeep.png" alt="" className="h-6 w-6 object-contain" /><span aria-hidden="true" className="absolute -right-1 bottom-0 h-2 w-2 rounded-full bg-primary" /></span>Online jeepney</li>
          <li className="flex items-center gap-2"><span className="flex h-6 w-6 items-center justify-center relative"><img src="/larga-jeep/larga-jeep.png" alt="" className="h-6 w-6 object-contain" /><span aria-hidden="true" className="absolute -right-1 bottom-0 h-2 w-2 rounded-full bg-red-600" /></span>Full jeepney</li>
